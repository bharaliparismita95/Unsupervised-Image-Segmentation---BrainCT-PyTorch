...
if __name__ == '__main__':
    # ------------------------ Runtime Parameters ---------------------------
    data_path: str = os.path.join('training_images', 'train-small.hdf5')
    # model: str = None
    ...
    # ------------------Loading model and pushing to CUDA if needed-----------------
    ...
    # ---------------Visualizing segmentation on 5 test images------------------
    idx = np.random.randint(x_val.shape[0], size=(5, ))
    inputs = x_val[idx]

    # ---------------Visualizing segmentaion on all test images------------------
